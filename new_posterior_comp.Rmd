...
b.mle=t(b.gp.hat[j,])
plot(b.mle,post.means[j,],main="PostMeanvsMLE")##concern because the order of magnitude diff, but prior weight heavy on (U.0kl[[2]][[3]]) which has very small avg. variance
#dev.off()
